 ...
 * @author sanji
 */
@WebServlet(name = "removeOrderLine", urlPatterns = {"/removeOrderLine"})
public class removeOrderLine extends HttpServlet {
    @EJB
       ...
       String orderLine=request.getParameter("Lineid");
            String orderNo=request.getParameter("orderno");
             double amount =Double.parseDouble(request.getParameter("amount"));
              ...
              customerOrderLineFacade.remove(ol);
              
               double orderAmount=customerController.reduceCustomerOrderAmount(orderNo,amount);
